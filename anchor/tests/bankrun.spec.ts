...
describe('Lending Smart Contract Tests', async () => {
  ...
  it('Test Init and Fund USDC Bank', async () => {
    const initUSDCBankTx = await program.methods
      .initBank(new BN(1),new BN(1),"0xeaa020c61cc479712813461ce153894a96a6c00b21ed0cfc2798d1f9a9e9c94a","USDC")
      .accounts({
        signer: signer.publicKey,
        mint: mintUSDC,
  ...
  it('Test Init amd Fund SOL Bank', async () => {
    const initSOLBankTx = await program.methods
      .initBank(new BN(1), new BN(1),"0xef0d8b6fda2ceba41da15d4095d1da392a0d2f8ed0c6c7bc0f4cfac8c280b56d","SOL")
      .accounts({
        signer: signer.publicKey,
        mint: mintSOL,
        tokenProgram: TOKEN_PROGRAM_ID,
